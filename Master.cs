...
public static class MST
{
    ...
    public static string createTable_JoinLeave = "CREATE TABLE IF NOT EXISTS JoinLeave (ID int, PlayerID text, JoinLeave int, WorldID text, LogDate int, LogTime int, PRIMARY KEY (ID))";
